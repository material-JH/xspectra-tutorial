...
2. [이 튜토리얼에 필요한 리눅스 기초](docs/01_linux_basics_for_tutorial.md)
3. [Quantum ESPRESSO 입력 파일 기초](docs/02_quantum_espresso_input_basics.md)
4. [XSpectra 계산 흐름](docs/03_xspectra_pipeline.md)
5. [Diamond C K-edge 예제](docs/04_diamond_walkthrough.md)
6. [SrTiO3 O K-edge 예제](docs/05_srtio3_o_kedge_walkthrough.md)
7. [SrTiO3 Ti L-edge 예제](docs/06_srtio3_ti_ledge_walkthrough.md)
...
- `diamond/` — 짧은 Diamond C K-edge 연습 예제입니다.
- `SrTiO3/` — O K-edge, Ti L-edge, core-hole, supercell, EELS 비교 예제가 들어 있습니다.
