...
echo "  Running xspectra.x (Ti L-edge HCH, dipole)..."
$XS_CMD < xspectra.in > xspectra.out 2>&1
echo "  xspectra.x done (exit: $?)"
move_xanes_or_fail Ti_Ledge_HCH.dat
grep "xanes.*WALL" xspectra.out || true

echo ""
echo "  Ti L-edge HCH COMPLETE."
echo "  Output: Ti_Ledge_HCH.dat"
