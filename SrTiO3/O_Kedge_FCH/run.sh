...
Oh   15.999  O.pbe-n-kjpaw_psl.0.1-FCH.UPF
...
echo "  Running xspectra.x (O K-edge FCH, dipole)..."
$XS_CMD < xspectra.in > xspectra.out 2>&1
echo "  xspectra.x done (exit: $?)"
move_xanes_or_fail O_Kedge_FCH.dat
grep "xanes.*WALL" xspectra.out || true

echo ""
echo "  O K-edge FCH COMPLETE."
echo "  Output: O_Kedge_FCH.dat"
