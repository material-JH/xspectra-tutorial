...
echo "  Running xspectra.x (O K-edge HCH, dipole)..."
$XS_CMD < xspectra.in > xspectra.out 2>&1
echo "  xspectra.x done (exit: $?)"
move_xanes_or_fail O_Kedge_HCH.dat
grep "xanes.*WALL" xspectra.out || true

echo ""
echo "  O K-edge HCH COMPLETE."
echo "  Output: O_Kedge_HCH.dat"
