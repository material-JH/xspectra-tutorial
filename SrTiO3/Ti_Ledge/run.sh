...
Tih  47.867  Ti.pbe-spn-kjpaw_psl.1.0.0.UPF
...
echo "  Running xspectra.x (Ti L-edge, dipole)..."
$XS_CMD < xspectra.in > xspectra.out 2>&1
echo "  xspectra.x done (exit: $?)"
move_xanes_or_fail Ti_Ledge.dat
grep "xanes.*WALL" xspectra.out || true

echo ""
echo "  Ti L-edge COMPLETE."
echo "  Output: Ti_Ledge.dat"
